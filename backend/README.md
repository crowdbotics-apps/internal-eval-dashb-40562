...
## Project Structure
    ...
    ├── internal_eval_dashb_40562  # Django project configurations
...
1. Clone this repo and `cd internal_eval_dashb_40562`
...
2. Clone this repo and `cd internal_eval_dashb_40562`
